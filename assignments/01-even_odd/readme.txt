...
Create a slice hard-coded with the 11 elements, 0 through 10; iterate and test for even/odd using the modulo operator and print the appropriate message.
The biggest challenge was confusing slices and arrays (my first implementation created an array), remembering the syntax and trying to figure out a slick way to initialize the slice (I didn't).
